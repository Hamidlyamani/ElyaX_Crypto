...
export const Coin = (data: coinType) => {
    ...
    return (
        <div className=' bg-gray-10 dark:bg-black_coin p-2 md:p-4 my-2  rounded-3xl flex flex-col justify-between  w-[calc(50%_-_8px)] lg:w-1/4   '>
            ...
            <div className="prix flex mt-8 gap-1 justify-between items-end">
                ...
                <div className="chart h-[40px] md:h-[60px] w-1/2 min-w-[50px] ">
